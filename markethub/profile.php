...
// --- LOGIKA UPDATE PROFIL di profile.php ---
...
<head>
    ...
    <style>
        ...
        .profile-pic { width: 150px; height: 150px; border-radius: 50%; object-fit: cover; border: 4px solid white; box-shadow: 0 4px 10px rgba(0,0,0,0.1); background: #e5e7eb; }
        .btn-upload { display: inline-block; margin-top: 10px; font-size: 13px; color: var(--primary); cursor: pointer; font-weight: 600; }
        .btn-delete { color: #ef4444; font-size: 12px; text-decoration: none; display: block; margin-top: 5px; }

        .form-group { margin-bottom: 15px; }
        label { display: block; font-size: 14px; font-weight: 600; margin-bottom: 5px; color: #4b5563; }
        input, textarea { width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px; font-family: inherit; box-sizing: border-box; }
        .btn-save { background: var(--primary); color: white; border: none; padding: 12px 20px; border-radius: 8px; font-weight: 600; cursor: pointer; width: 100%; }
        
        .header-nav { display: flex; justify-content: space-between; margin-bottom: 20px; grid-column: span 2; }
        @media (max-width: 768px) { .container { grid-template-columns: 1fr; } .header-nav { grid-column: span 1; } }
    </style>
</head>
<body>
