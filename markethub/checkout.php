...
<head>
    ...
    <style>
        ...
        .login-warning { text-align: center; padding: 40px 20px; }
        .warning-icon { font-size: 50px; margin-bottom: 20px; display: block; }
        .btn-login-now { 
            display: inline-block; background: var(--primary); color: white; 
            padding: 12px 30px; border-radius: 8px; text-decoration: none; 
            font-weight: 600; margin-top: 20px; transition: 0.3s;
        }
        .btn-login-now:hover { background: #1d4ed8; transform: translateY(-2px); }
        ...
        input, textarea { width: 100%; padding: 12px; border: 1px solid #e2e8f0; border-radius: 8px; box-sizing: border-box; }
        .btn-pay { width: 100%; background: var(--primary); color: white; border: none; padding: 15px; border-radius: 8px; font-weight: 600; cursor: pointer; margin-top: 20px; }
